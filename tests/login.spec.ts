...
test('should return 401-UNAUTHORIZED and should not return token with incorrect password', async ({ request }) => {
  // prepare request body
...
test('should return 401-UNAUTHORIZED and should not return token with incorrect user', async ({ request }) => {
  // prepare request body
...
test('should return 200-OK and checks whether the response contains a valid JSON Web Token (JWT)',
  async ({ request }) => {
    // prepare request body
    const requestBody = LoginDto.createLoginDto()
...
test('should return METHOD_NOT_ALLOWED with incorrect HTTP method',
  async ({ request }) => {
    // prepare request body
    const requestBody = LoginDto.createLoginDto()
